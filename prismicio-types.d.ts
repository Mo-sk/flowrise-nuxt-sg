...
/**
 * Primary content in *TextImage → Image Left → Primary*
 */
export interface TextImageSliceImageLeftPrimary {
  /**
   * Heading field in *TextImage → Image Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_image.imageLeft.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *TextImage → Image Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_image.imageLeft.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *TextImage → Image Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_image.imageLeft.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextImageSliceImageLeft = prismic.SharedSliceVariation<
  "imageLeft",
  Simplify<TextImageSliceImageLeftPrimary>,
  never
>;
...
export interface TextImageSliceImageRightPrimary {
  /**
   * Heading field in *TextImage → Image Right → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_image.imageRight.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *TextImage → Image Right → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_image.imageRight.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextImageSlice,
      TextImageSliceImageLeftPrimary,

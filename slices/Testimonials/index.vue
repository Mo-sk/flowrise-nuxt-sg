...
const testimonials = computed(() => {
  return props.slice.primary.testimonials.map(item => item.testimonial).
  filter(testimonial => isFilled.contentRelationship
  (testimonial)) as unknown as Content.TestimonialDocument[]
})
</script>
    ...
    <div class="grid lg:grid-cols-3 grid-cols-1 gap-8">
      ...
      >
        <PrismicRichText
          ...
          class="text-2xl font-body text-slate-700 mb-8 leading-10 italic"
        />
